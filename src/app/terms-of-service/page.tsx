    ...
    return (
        <LegalPageLayout title="利用規約" updatedAt="2026年7月29日">
            ...
            <section>
                <h2>2. 管理画面の利用</h2>
                <p>
                    当サイトには、コンテンツ編集・稼働状況確認のための管理画面（<code>/edit</code>、
                    <code>/admin</code>）を設けています。管理画面は運営者本人のみが利用するものであり、あらかじめ許可された特定のGoogleアカウントを保有するユーザーのみログインできます。第三者向けのアカウント登録機能は提供していません。
                </p>
            </section>
            ...
            <section>
                <h2>4. 免責事項</h2>
                <p>
                    当サイトに掲載する情報の正確性・最新性・完全性について、運営者は保証しません。当サイトの利用により生じたいかなる損害についても、運営者は責任を負わないものとします。また、システムの停止・変更・中断を予告なく行う場合があります。
                </p>
            </section>
